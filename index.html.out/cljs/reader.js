...
var len__6092__auto___8994 = arguments.length;
var i__6093__auto___8995 = (0);
while(true){
if((i__6093__auto___8995 < len__6092__auto___8994)){
args__6099__auto__.push((arguments[i__6093__auto___8995]));

var G__8996 = (i__6093__auto___8995 + (1));
i__6093__auto___8995 = G__8996;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq8992){
var G__8993 = cljs.core.first(seq8992);
var seq8992__$1 = cljs.core.next(seq8992);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__8993,seq8992__$1);
});
...
var G__8997 = (function (){
sb.append(ch);

return sb;
})()
;
var G__8998 = cljs.reader.read_char(rdr);
sb = G__8997;
ch = G__8998;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__9001 = (groups[(6)]);
var G__9002 = (10);
return parseInt(G__9001,G__9002);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__9003 = cljs.reader.read_char(rdr);
ch = G__9003;
continue;
} else {
return ch;
...
var G__9004 = (((mret === rdr))?a:cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,mret));
a = G__9004;
continue;
} else {
cljs.reader.unread(rdr,ch);
...
var G__9005 = (((o === rdr))?a:cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,o));
a = G__9005;
continue;
}
}
...
;
var G__9007 = cljs.reader.read_char(reader);
buffer = G__9006;
ch = G__9007;
continue;
}
...
if(("\\" === ch)){
var G__9008 = (function (){
buffer.append(cljs.reader.escape_char(buffer,reader));

return buffer;
})()
;
var G__9009 = cljs.reader.read_char(reader);
buffer = G__9008;
ch = G__9009;
continue;
} else {
...
var G__9010 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__9011 = cljs.reader.read_char(reader);
buffer = G__9010;
ch = G__9011;
continue;
...
var G__9016 = (function (){var G__9014 = buffer;
G__9014.append(nch);

return G__9014;
})();
var G__9017 = cljs.reader.read_char(reader);
buffer = G__9016;
ch = G__9017;
continue;
}
...
var G__9018 = (function (){var G__9015 = buffer;
G__9015.append(ch);

return G__9015;
})();
var G__9019 = cljs.reader.read_char(reader);
buffer = G__9018;
ch = G__9019;
continue;
...
var G__9022 = reader;
var G__9023 = eof_is_error;
var G__9024 = sentinel;
var G__9025 = is_recursive;
reader = G__9022;
eof_is_error = G__9023;
sentinel = G__9024;
is_recursive = G__9025;
continue;
} else {
if(cljs.reader.comment_prefix_QMARK_(ch)){
var G__9026 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
var G__9027 = eof_is_error;
var G__9028 = sentinel;
var G__9029 = is_recursive;
reader = G__9026;
eof_is_error = G__9027;
sentinel = G__9028;
is_recursive = G__9029;
continue;
} else {
...
var vec__9038 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9038,(10),null);
var v = vec__9038;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__9039 = months__$1;
var G__9040 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__9039,G__9040) : cljs.reader.days_in_month.call(null,G__9039,G__9040));
...
if(cljs.core.truth_(temp__4423__auto__)){
var vec__9042 = temp__4423__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9042,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9042,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9042,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9042,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9042,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9042,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9042,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9042,(7),null);
...
var arr = [];
var seq__9055_9067 = cljs.core.seq(form);
var chunk__9056_9068 = null;
var count__9057_9069 = (0);
var i__9058_9070 = (0);
while(true){
if((i__9058_9070 < count__9057_9069)){
var x_9071 = chunk__9056_9068.cljs$core$IIndexed$_nth$arity$2(null,i__9058_9070);
arr.push(x_9071);

var G__9072 = seq__9055_9067;
var G__9073 = chunk__9056_9068;
var G__9074 = count__9057_9069;
var G__9075 = (i__9058_9070 + (1));
seq__9055_9067 = G__9072;
chunk__9056_9068 = G__9073;
count__9057_9069 = G__9074;
i__9058_9070 = G__9075;
continue;
} else {
var temp__4425__auto___9076 = cljs.core.seq(seq__9055_9067);
if(temp__4425__auto___9076){
var seq__9055_9077__$1 = temp__4425__auto___9076;
if(cljs.core.chunked_seq_QMARK_(seq__9055_9077__$1)){
var c__5837__auto___9078 = cljs.core.chunk_first(seq__9055_9077__$1);
var G__9079 = cljs.core.chunk_rest(seq__9055_9077__$1);
var G__9080 = c__5837__auto___9078;
var G__9081 = cljs.core.count(c__5837__auto___9078);
var G__9082 = (0);
seq__9055_9067 = G__9079;
chunk__9056_9068 = G__9080;
count__9057_9069 = G__9081;
i__9058_9070 = G__9082;
continue;
} else {
var x_9083 = cljs.core.first(seq__9055_9077__$1);
arr.push(x_9083);

var G__9084 = cljs.core.next(seq__9055_9077__$1);
var G__9085 = null;
var G__9086 = (0);
var G__9087 = (0);
seq__9055_9067 = G__9084;
chunk__9056_9068 = G__9085;
count__9057_9069 = G__9086;
i__9058_9070 = G__9087;
continue;
}
} else {
}
...
var obj = {};
var seq__9061_9088 = cljs.core.seq(form);
var chunk__9062_9089 = null;
var count__9063_9090 = (0);
var i__9064_9091 = (0);
while(true){
if((i__9064_9091 < count__9063_9090)){
var vec__9065_9092 = chunk__9062_9089.cljs$core$IIndexed$_nth$arity$2(null,i__9064_9091);
var k_9093 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9065_9092,(0),null);
var v_9094 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9065_9092,(1),null);
(obj[cljs.core.name(k_9093)] = v_9094);

var G__9095 = seq__9061_9088;
var G__9096 = chunk__9062_9089;
var G__9097 = count__9063_9090;
var G__9098 = (i__9064_9091 + (1));
seq__9061_9088 = G__9095;
chunk__9062_9089 = G__9096;
count__9063_9090 = G__9097;
i__9064_9091 = G__9098;
continue;
} else {
var temp__4425__auto___9099 = cljs.core.seq(seq__9061_9088);
if(temp__4425__auto___9099){
var seq__9061_9100__$1 = temp__4425__auto___9099;
if(cljs.core.chunked_seq_QMARK_(seq__9061_9100__$1)){
var c__5837__auto___9101 = cljs.core.chunk_first(seq__9061_9100__$1);
var G__9102 = cljs.core.chunk_rest(seq__9061_9100__$1);
var G__9103 = c__5837__auto___9101;
var G__9104 = cljs.core.count(c__5837__auto___9101);
var G__9105 = (0);
seq__9061_9088 = G__9102;
chunk__9062_9089 = G__9103;
count__9063_9090 = G__9104;
i__9064_9091 = G__9105;
continue;
} else {
var vec__9066_9106 = cljs.core.first(seq__9061_9100__$1);
var k_9107 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9066_9106,(0),null);
var v_9108 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9066_9106,(1),null);
(obj[cljs.core.name(k_9107)] = v_9108);

var G__9109 = cljs.core.next(seq__9061_9100__$1);
var G__9110 = null;
var G__9111 = (0);
var G__9112 = (0);
seq__9061_9088 = G__9109;
chunk__9062_9089 = G__9110;
count__9063_9090 = G__9111;
i__9064_9091 = G__9112;
continue;
}
} else {
}
...
cljs.reader._STAR_tag_table_STAR_ = (function (){var G__9113 = new cljs.core.PersistentArrayMap(null, 4, ["inst",cljs.reader.read_date,"uuid",cljs.reader.read_uuid,"queue",cljs.reader.read_queue,"js",cljs.reader.read_js], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__9113) : cljs.core.atom.call(null,G__9113));
})();
...
var G__9117 = cljs.reader.read(rdr,true,null,false);
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__9117) : pfn.call(null,G__9117));
} else {
if(cljs.core.truth_(dfn)){
var G__9118 = tag;
var G__9119 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__9118,G__9119) : dfn.call(null,G__9118,G__9119));
} else {
